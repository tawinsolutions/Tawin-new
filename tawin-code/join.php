...
<head>
   ...
   <title>Join Us | TAWIN Solutions | Your Trusted Partner for Software & IT Consulting</title>
            ...
            <div class="parallax_cover">
               ...
               <div class="container">
                     ...
                     <div class="col-lg-10">
                        <div class="title_all_box style_one text-center dark_color">
                           <div class="title_sections">
                              ...
                              <h2 class="title">Redifinding Possibilities, Delivering Success</h2>
                              <p style="font-size: 24px;">Your Trusted Partner for Software & IT Consulting</p>
                           </div>
                           <!--===============spacing==============-->
                  ...
                  <div class="process-content-wapper">
                     <div class="row">
                        <div class="col-xl-4 col-lg-6 col-sm-12 col-md-6 pd_zero border_r">
                           <div class="icon_box_all style_six version_2">
                              <div class="icon_content">
                                 
                                 <div class="text_box">
                                    <h2><a href="#"> CANDIDATE PROFILE SUBMISSION</a></h2>
                                    <p>Placeholder for Candidates to Submit the Profile - Will Share a Form > Gets Saved to One Drive or GDrive</p>
									
									<a href="#" rel="nofollow" class="theme-btn three">Submit JD <i class="fa fa-file-text"></i></a>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-sm-12 col-md-6 pd_zero border_r">
                           <div class="icon_box_all style_six version_2">
                              <div class="icon_content">
                                 ...
                                 <div class="text_box">
                                    <h2><a href="#" target="_blank" rel="nofollow"> PARTNER JOB DESCRIPTION SUBMISSION</a></h2>
                                    <p>Placeholder for the End Partners to Submit the Job Description > Saved into to <br>One Drive or GDrive</p>
									
									<a href="#" rel="nofollow" class="theme-btn three">Submit Profile <i class="fa fa-cloud-upload"></i></a>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-sm-12 col-md-6 pd_zero border_r">
                           <div class="icon_box_all style_six version_2">
                              ...
                              <div class="about_authour_widget">
                                 ...
                                 <p>Know a talented IT professional? Connect them with us and grow our ecosystem of experts.</p>
