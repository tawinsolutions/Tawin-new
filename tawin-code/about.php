...
<head>
   ...
   <title>About Us | TAWIN Solutions | Your Trusted Partner for Software & IT Consulting</title>
                     ...
                     <div class="col-xl-6 col-lg-12 col-md-12 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
                        <div class="title_all_box style_one dark_color">
                           <div class="title_sections left">
                              ...
                              <h2 class="title" style="font-size: 27px;"> <span style="color: #007bc4;">About Us:</span> Our Vision & Mission</h2>
                              <p> Tawin Solutions is the premier partner for organizations navigating the complexities of digital change. Our vision is to serve as the definitive technology partner, bridging the gap between ambitious business objectives and technical execution through reliable consulting and elite talent.
.</p>
                              <p>Our mission is predicated on a simple truth: We succeed only when our clients succeed. We don't just provide resources; we operate as a high-velocity extension of your internal team, bringing clarity, speed, and uncompromising accountability to every initiative. By delivering skilled IT analysts and consultants, we empower organizations to execute technology projects with precision and drive measurable business outcomes.
</p>
                           </div>
                        </div>
                        <!--===============spacing==============-->
                     ...
                     <div class="col-xl-6 col-lg-10 col-md-12">
                        <div class="image_boxes style_five">
                           <div class="image_box one">
                              <img src="assets/images/about-4.jpg" class="img-fluid" alt="img">
